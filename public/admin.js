// ===== ADMIN DASHBOARD JAVASCRIPT - SINGLE DEPLOYMENT =====
console.log('👑 Tracle-Lite V2 Admin Dashboard - Single Deployment');
...
let API_BASE_URL, WEB_SOCKET_URL;

// For single deployment, always use same origin
API_BASE_URL = window.location.origin;
WEB_SOCKET_URL = window.location.origin.replace('http', 'ws');

console.log('🌐 Environment: Single Deployment');
...
class AdminDashboard {
            ...
            this.showCustomModal(
                ...
                async () => {
                    try {
                        ...
                        const response = await fetch(`${API_BASE_URL}/api/admin/settings/update-template`, {
                            method: 'POST',
                            headers: {
    ...
    async editRevenue(email) {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/admin/user/${encodeURIComponent(email)}`, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Accept': 'application/json'
                }
            ...
            this.showCustomModal(
                ...
                async () => {
                    try {
                        ...
                        const response = await fetch(`${API_BASE_URL}/api/admin/user/edit-revenue`, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'Authorization': `Bearer ${token}`,
        ...
        this.showCustomModal(
            ...
            async () => {
                try {
                    ...
                    const response = await fetch(`${API_BASE_URL}/api/admin/token/terminate`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': `Bearer ${token}`,
    ...
    async grantFreeTokens(email, amount) {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/admin/token/generate-free`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
            ...
            if (data.success) {
                ...
                const balanceResponse = await fetch(`${API_BASE_URL}/api/admin/user/grant-tokens`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
        ...
        this.showCustomModal(
            ...
            async () => {
                try {
                    ...
                    const response = await fetch(`${API_BASE_URL}/api/admin/user/update`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': `Bearer ${token}`,
        ...
        this.showCustomModal(
            ...
            async () => {
                try {
                    ...
                    const response = await fetch(`${API_BASE_URL}/api/admin/token/generate`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': `Bearer ${token}`,
                    ...
                    if (data.success) {
                        ...
                        if (freeTokensAmount > 0) {
                            const freeResponse = await fetch(`${API_BASE_URL}/api/admin/user/grant-tokens`, {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'Authorization': `Bearer ${token}`,
    ...
    async updateUserGrant(email, maxSessions, isPaid = false) {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/admin/user/update-grant`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
    ...
    async notifyUserAboutGrantUpdate(email, maxSessions) {
        try {
            const response = await fetch(`${API_BASE_URL}/api/admin/notify-user-grant`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('admin_token')}`,
    ...
    async remindPassword() {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/admin/send-reminder`, {
                method: 'POST',
                headers: { 
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
    ...
    async login() {
        ...
        try {
            ...
            if (!testResponse.ok) {
                this.showMessage('Backend server is not responding', 'error');
                return;
            }
        } catch (error) {
            this.showMessage('Cannot connect to backend server', 'error');
            return;
        }
        ...
        try {
            ...
            // Verify with backend
            const response = await fetch(`${API_BASE_URL}/api/admin/verify-login`, {
                method: 'POST',
                headers: { 
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
        ...
        this.showCustomModal(
            ...
            async () => {
                try {
                    ...
                    const response = await fetch(`${API_BASE_URL}/api/admin/user/payment`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': `Bearer ${token}`,
    ...
    async searchSessions(query) {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/admin/sessions/search`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
    ...
    async viewIndividualSessionDetails(sessionNumber) {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/admin/session/details/${sessionNumber}`, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Accept': 'application/json'
                }
        ...
        this.showCustomModal(
            ...
            async () => {
                try {
                    ...
                    const response = await fetch(`${API_BASE_URL}/api/admin/session/${sessionNumber}`, {
                        method: 'DELETE',
                        headers: {
                            'Authorization': `Bearer ${token}`,
                            'Accept': 'application/json'
                    ...
                    async () => {
                        try {
                            ...
                            for (const session of userSessions.sessions) {
                                try {
                                    const deleteResponse = await fetch(`${API_BASE_URL}/api/admin/session/${session.sessionNumber}`, {
                                        method: 'DELETE',
                                        headers: {
                                            'Authorization': `Bearer ${token}`,
                                            'Accept': 'application/json'
    ...
    async loadLoginHistory() {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/admin/login-history?type=admin&limit=100`, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Accept': 'application/json'
                }
        ...
        this.showCustomModal(
            ...
            async () => {
                try {
                    ...
                    const response = await fetch(`${API_BASE_URL}/api/admin/login-history/cleanup`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': `Bearer ${token}`,
