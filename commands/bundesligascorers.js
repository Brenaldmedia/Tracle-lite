...
module.exports = {
    ...
    execute: async (conn, mek, m, { from, reply }) => {
        try {
            ...
            const response = await axios.get(`https://apiskeith.top/bundesliga/scorers`, { timeout: 15000 });
            
            if (!response.data?.status) {
                return reply(`❌ Could not fetch Bundesliga scorers.\n> ⚡ Powered by TRACLE-LITE`);
            }

            const scorers = response.data.result?.topScorers || [];
            let message = `⚽ *BUNDESLIGA TOP SCORERS* ⚽\n━━━━━━━━━━━━━━━━━━━━\n\n`;
